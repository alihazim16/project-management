            ...
            <div class="relative group">
                ...
                <div class="relative bg-gray-900/80 backdrop-blur-xl p-8 rounded-2xl border border-gray-700/50">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-400 text-sm mt-2">Please confirm your password to continue</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                <input type="password" 
                                       name="password" 
                                       class="w-full bg-gray-800/50 border border-gray-700/50 rounded-lg px-4 py-3 text-gray-100 focus:outline-none focus:border-cyan-500 transition duration-300 @error('password') border-red-500 @enderror"
                                       required>
